...
def write_artifacts_index(
    ...
    rows = [
        ...
        ("Distillation summary", paths.distillation_dir() / "summary.csv"),
        ("Distillation overrides", paths.distillation_dir() / "overrides.pt"),
        ("Distillation overrides summary", paths.distillation_dir() / "overrides_summary.csv"),
        ("Distillation report", paths.distillation_dir() / "report.md"),
